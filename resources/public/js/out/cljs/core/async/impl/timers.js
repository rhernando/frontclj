...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_19845 = (0);while(true){
if((i_19845 < arr.length))
{(arr[i_19845] = null);
{
...
{var i_19852 = (self__.level + (1));while(true){
if((i_19852 <= (new_level + (1))))
{(update[i_19852] = self__.header);
{
var G__19853 = (i_19852 + (1));
i_19852 = G__19853;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_19854 = (0);while(true){
if((i_19854 <= self__.level))
{var links_19855 = (update[i_19854]).forward;if(((links_19855[i_19854]) === x__$1))
{(links_19855[i_19854] = (x__$1.forward[i_19854]));
{
