...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14020 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t14020 = (function (val,box,meta14021){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14020.cljs$lang$type = true;
cljs.core.async.impl.channels.t14020.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14020";
cljs.core.async.impl.channels.t14020.cljs$lang$ctorPrWriter = (function (this__4123__auto__,writer__4124__auto__,opt__4125__auto__){return cljs.core._write.call(null,writer__4124__auto__,"cljs.core.async.impl.channels/t14020");
});
cljs.core.async.impl.channels.t14020.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t14020.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14022){var self__ = this;
var _14022__$1 = this;return self__.meta14021;
});
cljs.core.async.impl.channels.t14020.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14022,meta14021__$1){var self__ = this;
var _14022__$1 = this;return (new cljs.core.async.impl.channels.t14020(self__.val,self__.box,meta14021__$1));
});
cljs.core.async.impl.channels.__GT_t14020 = (function __GT_t14020(val__$1,box__$1,meta14021){return (new cljs.core.async.impl.channels.t14020(val__$1,box__$1,meta14021));
});
}
return (new cljs.core.async.impl.channels.t14020(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__4126__auto__,writer__4127__auto__,opts__4128__auto__){return cljs.core._write.call(null,writer__4127__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__4123__auto__,writer__4124__auto__,opt__4125__auto__){return cljs.core._write.call(null,writer__4124__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_14023 = self__.takes.pop();if((taker_14023 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_14023))
{var take_cb_14024 = cljs.core.async.impl.protocols.commit.call(null,taker_14023);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_14024,taker_14023,this$__$1){
return (function (){return take_cb_14024.call(null,null);
});})(take_cb_14024,taker_14023,this$__$1))
);
} else
{}
{
