...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t19944 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t19944 = (function (val,box,meta19945){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t19944.cljs$lang$type = true;
cljs.core.async.impl.channels.t19944.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t19944";
cljs.core.async.impl.channels.t19944.cljs$lang$ctorPrWriter = (function (this__4123__auto__,writer__4124__auto__,opt__4125__auto__){return cljs.core._write.call(null,writer__4124__auto__,"cljs.core.async.impl.channels/t19944");
});
cljs.core.async.impl.channels.t19944.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t19944.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_19946){var self__ = this;
var _19946__$1 = this;return self__.meta19945;
});
cljs.core.async.impl.channels.t19944.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_19946,meta19945__$1){var self__ = this;
var _19946__$1 = this;return (new cljs.core.async.impl.channels.t19944(self__.val,self__.box,meta19945__$1));
});
cljs.core.async.impl.channels.__GT_t19944 = (function __GT_t19944(val__$1,box__$1,meta19945){return (new cljs.core.async.impl.channels.t19944(val__$1,box__$1,meta19945));
});
}
return (new cljs.core.async.impl.channels.t19944(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_19947 = self__.takes.pop();if((taker_19947 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_19947))
{var take_cb_19948 = cljs.core.async.impl.protocols.commit.call(null,taker_19947);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_19948,taker_19947,this$__$1){
return (function (){return take_cb_19948.call(null,null);
});})(take_cb_19948,taker_19947,this$__$1))
);
} else
{}
{
