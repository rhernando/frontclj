...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14014 = (0);while(true){
var m_14015 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14015 == null))
{} else
{m_14015.call(null);
if((count_14014 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14016 = (count_14014 + (1));
count_14014 = G__14016;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3544__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3544__auto__)
