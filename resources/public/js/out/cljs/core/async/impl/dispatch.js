...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_19938 = (0);while(true){
var m_19939 = cljs.core.async.impl.dispatch.tasks.pop();if((m_19939 == null))
{} else
{m_19939.call(null);
if((count_19938 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__19940 = (count_19938 + (1));
count_19938 = G__19940;
continue;
}
} else
{}
