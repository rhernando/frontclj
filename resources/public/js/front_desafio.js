...
goog.addDependency("../front_desafio/core.js", ['front_desafio.core'], ['ajax.core', 'om_tools.dom', 'om_bootstrap.grid', 'cljs.core', 'om_bootstrap.panel', 'cljs_http.client', 'om.dom', 'cljs.core.async', 'om_bootstrap.nav', 'taoensso.sente', 'front_desafio.utils', 'om.core', 'om_bootstrap.button', 'taoensso.encore', 'goog.events', 'om_bootstrap.random', 'om_bootstrap.input']);
