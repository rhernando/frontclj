...
goog.addDependency("../front_desafio/core.js", ['front_desafio.core'], ['ajax.core', 'om_tools.dom', 'om_bootstrap.grid', 'cljs.core', 'om_bootstrap.panel', 'cljs_http.client', 'om.dom', 'goog.i18n.NumberFormat', 'cljs.core.async', 'om_bootstrap.nav', 'taoensso.sente', 'front_desafio.utils', 'om.core', 'om_bootstrap.button', 'taoensso.encore', 'om_bootstrap.table', 'goog.events', 'om_bootstrap.random', 'om_bootstrap.input']);
