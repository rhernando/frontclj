...
goog.addDependency("../front_desafio/core.js", ['front_desafio.core'], ['ajax.core', 'goog.History.EventType', 'om_tools.dom', 'om_bootstrap.grid', 'cljs.core', 'om_bootstrap.panel', 'cljs_http.client', 'om.dom', 'goog.i18n.NumberFormat', 'goog.History', 'cljs.core.async', 'om_bootstrap.nav', 'jayq.core', 'taoensso.sente', 'front_desafio.utils', 'om.core', 'secretary.core', 'om_bootstrap.button', 'taoensso.encore', 'om_bootstrap.table', 'goog.events', 'om_bootstrap.random', 'om_bootstrap.input']);
